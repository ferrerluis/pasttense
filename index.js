...
io.on('connection', function(socket) {
		socket.on('new msg', function(msg) {
			...
			request.models.messages.create([{
				"private": msg.private,
		...
		socket.on("like", function(messageId){
			request.models.messages.find(messageId, function(err, message){
				message.likes += 1;
		...
		socket.on("forward", function(data){
			...
			request.models.messages.find({"id": data.messageId}, 50, function(err, message){
